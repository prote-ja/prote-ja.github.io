...
export function StageSection({ lang }: StageSectionProps) {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{t("stage.title")}</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="border-blue-200 bg-blue-50">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">{t("stage.priorities")}</h3>
                <ul className="text-sm text-gray-700 space-y-2">
          ...
          <Card className="border-[#7257FF] bg-gradient-to-r from-purple-50 to-purple-100">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">{t("vision.description")}</p>
              <p className="text-lg font-medium text-[#7257FF]">{t("vision.mission")}</p>
            </CardContent>
          </Card>
        </div>
      </div>
